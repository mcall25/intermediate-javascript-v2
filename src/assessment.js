...
function context3() {
    var context4 = sum.bind(contextObj)
    return context4;
}
...
// #7  ###################
// # Implicit binding
// Make a constructor function called RoadTrip.  It has a property called gasLeft = 100.  It has a property called drive that is a function.  When drive is invoked it uses context to
// implicitly subract 10 from the gasLeft on the roadTrip.

var RoadTrip = function(gasLeft) {
    this.gasLeft = 100;
    this.drive = function() {
...
// #9  ###################
// # Prototype 2
// Write a constructor function called CoinToss.  It has a property called results which is an empty array.  It has a prototype function called flip.
 // When flip is invoked it uses context to implicitly add 'heads' or 'tails' to the results array.

 function CoinToss() {

      this.results = [];
      this.flip = function() {
         var ans = (Math.floor(Math.random() * 2) === 0) ? 'heads' : 'tails';
